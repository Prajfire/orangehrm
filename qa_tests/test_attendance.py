# test_attendance.py
# Testing attendance entry validation for construction site workers
# The site manager enters this from the site every day
# If wrong data is accepted here, wrong payslips get generated
